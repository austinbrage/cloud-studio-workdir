# Deploy Compute Engine to serve a Node API
...
This Terraform project sets up a complete Google Cloud network infrastructure, including a virtual network, subnet and network firewalls. Provisioning a Linux VM instance within the subnet, accessible via the internet and serving an API inside a Nginx server.
